      ...
      <AppBar
        ...
        right={
          <Pressable
            ...
            className={
              checking
                ? "rounded-xl bg-secondary px-3 py-2 items-center justify-center"
                : "rounded-xl bg-foreground px-3 py-2 items-center justify-center active:opacity-70"
            }
          >
            <Text
          ...
          <View className="gap-5">
            ...
            {loadError.length > 0 && (
              <View className="rounded-xl border border-border p-4 gap-2">
                ...
                <Text className="text-muted text-xs">
                  Your installed extensions still work offline. Bundled defaults can be installed
                  from the SMS setup wizard.
                </Text>
                <Pressable
