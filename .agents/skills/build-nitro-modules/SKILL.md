...
3. **Example app** — Should an example app be created to test the module? _(Recommended — default: yes)_
...
| 8        | Example app setup _(if requested)_        | HIGH     | [example-app-setup.md][example-app-setup]             |
| 9        | Android Gradle paths _(if example app)_   | HIGH     | [example-android-config.md][example-android-config]   |
| 10       | Metro + install + test _(if example app)_ | HIGH     | [example-metro-install.md][example-metro-install]     |
