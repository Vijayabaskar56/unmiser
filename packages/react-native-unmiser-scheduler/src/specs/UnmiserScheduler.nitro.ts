...
export interface UnmiserScheduler extends HybridObject<{ android: "kotlin" }> {
  /**
...
const unmiserScheduler = NitroModules.createHybridObject<UnmiserScheduler>("UnmiserScheduler");
